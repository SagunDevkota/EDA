...
<div id="download" style="margin-top:-50px; position:absolute;">
	<input type="button" value="download" style="
  ...
  <script type="text/javascript" src="<c:url value="/resources/js/printThis.js"/>"></script>
  <script type="text/javascript" src="<c:url value="/resources/js/download.js"/>"></script>
</body>
</html>